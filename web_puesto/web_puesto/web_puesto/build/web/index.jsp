                            ...
                            <div class="col-sm">
                                <form action="index.jsp" method="post">
                                    <div class="form-group">
                                        <label for="direccion"><b>Puestos</b></label>   
                                        <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Ejemplo: Programador" required>
                                    </div>                       
                                    <button type="submit" class="btn btn-primary" name="enviar">Guardar <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
                                </form>
                            </div>
                        </div>
                        <br>
                        ...
                        <tbody class ="tbl_puestos">
                            <%
                                try {
                                    ...
                                    rs = st.executeQuery("SELECT * FROM puestos;");
                                    while (rs.next()) {
                            %>
        ...
        <%
            if (request.getParameter("enviar") != null) {
                ...
                try {
                    ...
                    stt.executeUpdate("insert into puestos (puestos) values('" + direccion + "')");
